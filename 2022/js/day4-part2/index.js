...
fs.readFile('input.txt', 'utf-8', (err, data) => {
    ...
    for (let i = 0; i < pairs.length; i++) {
        ...
        if (leftSideNum1 >= rightSideNum1 && leftSideNum2 <= rightSideNum2) {
            ...
            pairsThatOverlap += 1
        } else if (leftSideNum2 === rightSideNum1) {
            pairsThatOverlap += 1
        } else if (rightSideNum1 <= leftSideNum2 && rightSideNum1 >= leftSideNum1) {
            pairsThatOverlap += 1
        } else if (leftSideNum1 >= rightSideNum1 && leftSideNum1 <= rightSideNum2) {
            pairsThatOverlap += 1
        }
    }

    console.log(pairsThatOverlap);
})