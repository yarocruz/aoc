...
fs.readFile('input.txt', 'utf-8', (err, data) => {
    ...
    let octoSize = octoGrid[0].length * octoGrid.length

    // brute forced it here, this should be a while loop
    for (let k = 1; k <= 250; k++) {
        ...
        if (countFlashesInARow(flashMap) === octoSize) {
            // print step when the all flash
            console.log(k)
            break;
        }
    ...
    function countFlashesInARow(flashMap) {
    ...
    // I realize this is the brute force way
